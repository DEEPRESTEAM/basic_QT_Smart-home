    ...
    ui(new Ui::MyWidget)
{
    ...
    if(check1 == 1){
        ...
        this->show();
        connect(this , &MyWidget::loginStart , ldp , &LoadPage::start);
        Login();
    }else {
        this->show();
    }
    ...
    //实现登录的绑定
    connect(ui->btnLogin , &QPushButton::clicked , this , &MyWidget::log);
    connect(this , &MyWidget::log , this , &MyWidget::Login);
    ...
    connect(ldp , &LoadPage::complete , this , [=](){
        //this->show();
        ldp->close();
        cent->show();
    });
